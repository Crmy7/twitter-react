...
const TwitCard: React.FC<TwitCardProps> = ({ title, content, author }) => {
  return (
    <div className="bg-gray-50 dark:bg-black mb-5 flex items-center justify-center">
      <div className="bg-white dark:bg-black border-gray-200 dark:border-gray-800 p-4 rounded-xl border max-w-xl">
